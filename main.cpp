...
int get_word_len(string prompt); // return a positive integer
bool get_y_or_n(string prompt); // return a positive integer
...
int main() {
    ...
    while (true) {
        ...
        int word_len = get_word_len("How many letters would you like the word to be?");
        ...
        bool ans = get_y_or_n("Would you like to display the number of remaining words?");
//
//        cout << "Would you like to display the number of remaining words?";
//        cin >> answer;
//
        ...
        // prompted for above
        game.start_new_game(num_guesses, word_len, ans);
...
int get_word_len(string msg) {
    while (true) {
        ...
        cout << "Please enter a value between 0 and 30!.";
        cout << endl;
    }
}


bool get_y_or_n(string msg) {
    while (true) {
        string answer;
        string input;
        bool ans;
